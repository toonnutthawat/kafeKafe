...
//จัดการเรื่อง security และการจำกัดสิทธิ์ตาม ROlE
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers(new AntPathRequestMatcher("/")).permitAll()//any path that match pattern will permit all. Don't login anymore
